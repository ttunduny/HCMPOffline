...
<!-- Mirrored from www.cliptheme.com/preview/admin/clip-one/index.html by HTTrack Website Copier/3.x [XR&CO'2013], Fri, 22 Aug 2014 10:30:52 GMT -->
<head>
		...
		<!-- end: META -->
		<!-- start: MAIN CSS -->
		<link rel="stylesheet" href="<?php echo base_url() . 'assets/boot-strap3/css/bootstrap.min.css' ?>">
		<link rel="stylesheet" href="assets1/plugins/font-awesome/css/font-awesome.min.css">
		<link rel="stylesheet" href="assets/css/eid/fonts/style.css">
		<link rel="stylesheet" href="assets/css/eid/css/main.css">
		<link rel="stylesheet" href="assets/css/eid/css/main-responsive.css">
		<link rel="stylesheet" href="assets/css/eid/css/theme_light.css" type="text/css" id="skin_color">
		<link rel="stylesheet" href="assets/css/eid/css/print.css" type="text/css" media="print"/>
		<!--[if IE 7]>
		<link rel="stylesheet" href="assets1/plugins/font-awesome/css/font-awesome-ie7.min.css">
		<![endif]-->
		<!-- end: MAIN CSS -->
		<!-- start: CSS REQUIRED FOR THIS PAGE ONLY -->
		<link rel="stylesheet" href="assets1/plugins/fullcalendar/fullcalendar/fullcalendar.css">
	...
	<body>
				...
				<div class="navbar-tools">
					...
					<ul class="nav navbar-right">
										...
										<ul>
												...
												<a href="javascript:;">
													<div class="clearfix">
														<div class="thread-image">
															<img alt="" src="assets1/images/avatar-2.jpg">
														</div>
											...
											<li>
												<a href="javascript:;">
													<div class="clearfix">
														<div class="thread-image">
															<img alt="" src="assets1/images/avatar-1.jpg">
														</div>
														<div class="thread-content">
											...
											<li>
												<a href="javascript:;">
													<div class="clearfix">
														<div class="thread-image">
															<img alt="" src="assets1/images/avatar-3.jpg">
														</div>
														<div class="thread-content">
											...
											<li>
												<a href="javascript:;">
													<div class="clearfix">
														<div class="thread-image">
															<img alt="" src="assets1/images/avatar-5.jpg">
														</div>
														<div class="thread-content">
						...
						<li class="dropdown current-user">
							<a data-toggle="dropdown" data-hover="dropdown" class="dropdown-toggle" data-close-others="true" href="#">
								<img src="assets1/images/avatar-1-small.jpg" class="circle-img" alt="">
							...
							<div id="style_selector" class="hidden-xs">
								<div id="style_selector_container" style="display:block">
									...
									<div class="images boxed-patterns">
										<a id="bg_style_1" href="#"><img alt="" src="assets1/images/bg.png"></a>
										<a id="bg_style_2" href="#"><img alt="" src="assets1/images/bg_2.png"></a>
										<a id="bg_style_3" href="#"><img alt="" src="assets1/images/bg_3.png"></a>
										<a id="bg_style_4" href="#"><img alt="" src="assets1/images/bg_4.png"></a>
										<a id="bg_style_5" href="#"><img alt="" src="assets1/images/bg_5.png"></a>
									</div>
									<div class="box-title">
										5 Predefined Color Schemes
									</div>
									<div class="images icons-color">
										<a id="light" href="#"><img class="active" alt="" src="assets1/images/lightgrey.png"></a>
										<a id="dark" href="#"><img alt="" src="assets1/images/darkgrey.png"></a>
										<a id="black_and_white" href="#"><img alt="" src="assets1/images/blackandwhite.png"></a>
										<a id="navy" href="#"><img alt="" src="assets1/images/navy.png"></a>
										<a id="green" href="#"><img alt="" src="assets1/images/green.png"></a>
									</div>
									<div class="box-title">
										Style it with LESS
									</div>
							...
							<div class="panel panel-default">
								...
								<div class="panel-body panel-scroll" style="height:300px">
									<table class="table table-striped table-hover" id="sample-table-1">
										...
										<tbody>
											<tr>
												<td class="center"><img src="assets1/images/avatar-1.jpg" alt="image"/></td>
												<td>Peter Clark</td>
												<td class="hidden-xs">
											...
											<tr>
												<td class="center"><img src="assets1/images/avatar-2.jpg" alt="image"/></td>
												<td>Nicole Bell</td>
												<td class="hidden-xs">
												<a href="#" rel="nofollow" target="_blank">
													nicole@example.com
											...
											<tr>
												<td class="center"><img src="assets1/images/avatar-3.jpg" alt="image"/></td>
											...
											<tr>
												<td class="center"><img src="assets1/images/avatar-5.jpg" alt="image"/></td>
												<td>Kenneth Ross</td>
												<td class="hidden-xs">
												<a href="#" rel="nofollow" target="_blank">
													kenneth@example.com
											...
											<tr>
												<td class="center"><img src="assets1/images/avatar-4.jpg" alt="image"/></td>
									...
									<div class="panel panel-default">
										...
										<div class="panel-body panel-scroll" style="height:460px">
											<ol class="discussion">
												<li class="other">
													<div class="avatar">
														<img alt="" src="assets1/images/avatar-4.jpg">
													</div>
													<div class="messages">
														<p>
															Lorem ipsum dolor sit amet, consectetuer adipiscing elit, sed diam nonummy nibh euismod tincidunt ut laoreet dolore magna aliquam erat volutpat.
					...
					<div class="tab-pane active" id="users">
						<div class="users-list">
							...
							<ul class="media-list">
								<li class="media">
									<a href="#">
										...
										<img alt="..." src="assets1/images/avatar-2.jpg" class="media-object">
								...
								<li class="media">
									<a href="#">
										...
										<i class="fa fa-circle status-online"></i>
										<img alt="..." src="assets1/images/avatar-3.jpg" class="media-object">
										<div class="media-body">
								...
								<li class="media">
									<a href="#">
										<i class="fa fa-circle status-online"></i>
										<img alt="..." src="assets1/images/avatar-4.jpg" class="media-object">
										<div class="media-body">
								...
								<li class="media">
									<a href="#">
										<i class="fa fa-circle status-online"></i>
										<img alt="..." src="assets1/images/avatar-5.jpg" class="media-object">
										<div class="media-body">
							...
							<ul class="media-list">
								<li class="media">
									<a href="#">
										<img alt="..." src="assets1/images/avatar-6.jpg" class="media-object">
										<div class="media-body">
											<h4 class="media-heading">Nicole Bell</h4>
											<span> Content Designer </span>
										</div>
								...
								<li class="media">
									<a href="#">
										...
										<img alt="..." src="assets1/images/avatar-7.jpg" class="media-object">
										<div class="media-body">
											<h4 class="media-heading">Steven Thompson</h4>
											<span> Visual Designer </span>
										</div>
								...
								<li class="media">
									<a href="#">
										<img alt="..." src="assets1/images/avatar-8.jpg" class="media-object">
										<div class="media-body">
											<h4 class="media-heading">Ella Patterson</h4>
											<span> Web Editor </span>
										</div>
								...
								<li class="media">
									<a href="#">
										<img alt="..." src="assets1/images/avatar-9.jpg" class="media-object">
										<div class="media-body">
											<h4 class="media-heading">Kenneth Ross</h4>
											<span> Senior Designer </span>
										</div>
								...
								<li class="media">
									<a href="#">
										<img alt="..." src="assets1/images/avatar-10.jpg" class="media-object">
										<div class="media-body">
											<h4 class="media-heading">Ella Patterson</h4>
											<span> Web Editor </span>
										</div>
						...
						<div class="user-chat">
							...
							<ol class="discussion sidebar-content">
								<li class="other">
									<div class="avatar">
										<img src="assets1/images/avatar-4.jpg" alt="">
									</div>
									<div class="messages">
										<p>
											Lorem ipsum dolor sit amet, consectetuer adipiscing elit, sed diam nonummy nibh euismod tincidunt ut laoreet dolore magna aliquam erat volutpat.
								...
								<li class="self">
									<div class="avatar">
										<img src="assets1/images/avatar-1.jpg" alt="">
									</div>
									<div class="messages">
										<p>
											Lorem ipsum dolor sit amet, consectetuer adipiscing elit, sed diam nonummy nibh euismod tincidunt ut laoreet dolore magna aliquam erat volutpat.
		...
		<script src="assets1/plugins/excanvas.min.js"></script>
		<script type="text/javascript" src="assets1/plugins/jQuery-lib/1.10.2/jquery.min.js"></script>
		<![endif]-->
		<!--[if gte IE 9]><!-->
		<script src="assets1/plugins/jQuery-lib/2.0.3/jquery.min.js"></script>
		<!--<![endif]-->
		<script src="assets1/plugins/jquery-ui/jquery-ui-1.10.2.custom.min.js"></script>
		<script src="assets1/plugins/bootstrap/js/bootstrap.min.js"></script>
		<script src="assets1/plugins/bootstrap-hover-dropdown/bootstrap-hover-dropdown.min.js"></script>
		<script src="assets1/plugins/blockUI/jquery.blockUI.js"></script>
		<script src="assets1/plugins/iCheck/jquery.icheck.min.js"></script>
		<script src="assets1/plugins/perfect-scrollbar/src/jquery.mousewheel.js"></script>
		<script src="assets1/plugins/perfect-scrollbar/src/perfect-scrollbar.js"></script>
		<script src="assets1/plugins/less/less-1.5.0.min.js"></script>
		<script src="assets1/plugins/jquery-cookie/jquery.cookie.js"></script>
		<script src="assets1/plugins/bootstrap-colorpalette/js/bootstrap-colorpalette.js"></script>
		<script src="assets1/js/main.js"></script>
		<!-- end: MAIN JAVASCRIPTS -->
		<!-- start: JAVASCRIPTS REQUIRED FOR THIS PAGE ONLY -->
		<script src="assets1/plugins/flot/jquery.flot.js"></script>
		<script src="assets1/plugins/flot/jquery.flot.pie.js"></script>
		<script src="assets1/plugins/jquery-easy-pie-chart/jquery.easy-pie-chart.js"></script>
		<script src="assets1/plugins/jquery-ui-touch-punch/jquery.ui.touch-punch.min.js"></script>
		<script src="assets1/plugins/fullcalendar/fullcalendar/fullcalendar.js"></script>
...
<!-- Mirrored from www.cliptheme.com/preview/admin/clip-one/index.html by HTTrack Website Copier/3.x [XR&CO'2013], Fri, 22 Aug 2014 10:30:53 GMT -->
</html>