...
<div align="center">
 ...
 <div class="demo" style="margin: 10px;">
       <div id="accordion">
               ...
               foreach($drug_categories as $category){?>
                       ...
                       <p>
                               <table>
                                       <tr>
                                               <td><b>KEMSA Code</b></td><td><b>Facility Code</b></td><td><b>Batch No</b></td><td><b>Manufacturer</b></td><td><b>Expiry Date</b></td><td><b>Stock Balance</b></td>
                                       </tr>
                                       <?php
                                               foreach($category->Category_Drugs as $drug){?>
                                               <tr>
                                                       <td><?php echo $drug->Kemsa_Code;?></td><td><?php echo $drug->Drug_Name;?></td><td></td>
                                               </tr>
                                               <?php
                                               }
                                       ?>
       ...
       <table style="font-family: Helvetica, Arial, sans-serif;">
               <tr>
                       <td><b> Total Stock Balance</b></td><td><b> 440000 </b></td>
               </tr>
       </table>
</div><!-- End demo -->
