...
<?php echo form_open('user_management/edit_facility'); ?>

				<table class="data-table" width="800">
	
	
	<?php echo validation_errors('<p class="error">','</p>'); ?>
	<?php foreach( $users_det as $row)?>
	<tr><p>
		<input type="hidden" name="user_id" value="<?php echo $this->uri->segment(3);?>" />
		<td><label for="fname">First Name:</label></td>
		<td><input type="text" name="fname" id="ValidField" value="<?php echo $row->fname;?>" /></td>
	</p>
	</tr>
	<tr><p>
		<td><label for="fname">Other Names:</label></td>
		<td><input type="text" name="lname" id="ValidField1" onblur="callme(this);" value="<?php echo $row->lname;?>"/></td>
	</p></tr>
	<tr><p>
		<td><label for="fname">Mobile Number: eg 254728242546</label></td>
		<td><input type="text" name="tell" id="Mobile" value="<?php echo $row->telephone;?>" /></td>
	</p></tr>
	<tr><p>
