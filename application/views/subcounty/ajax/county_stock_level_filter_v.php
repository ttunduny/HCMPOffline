...
<select id="facility_filter" class="form-control col-md-3">
...
<div class="col-md-1">
<button class="btn btn-sm btn-success filter"><span class="glyphicon glyphicon-filter"></span>Filter</button> 
</div>
<div class="col-md-1">
