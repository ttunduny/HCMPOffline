	...
	<div class="page_content">
		...
		<!-- <li class="active"><a href="#">Currently Logged In</a></li> -->
			...
			<?php endif; ?>
					...
					<li	class = "<?php $active = ($active == 'county')? 'active':NULL; echo $active;?>" ><a data-toggle="tab"  href="#subcounty_users">Subcounty Users</a></li>
					<li	class = "<?php $active = ($active == 'county')? 'active':NULL; echo $active;?>" ><a data-toggle="tab"  href="#facility_users">Facility Users</a></li> 
			...
			<?php endif; ?>
				<div id="county_users" class="tab-pane fade in <?php $active = ($active == 'county')? 'active':NULL; echo $active;?>">
					<div class="row">
