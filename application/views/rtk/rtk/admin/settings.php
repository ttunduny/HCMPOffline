...
<div id="content">  
  <h5>DEADLINES</h5>
  <a data-target="#Add_Deadline" role="button" class="btn" data-toggle="modal">Add New</a> 
    <br/>
    <hr/>
  <div id="deadlines">  
    ...
    <hr/>
    <h5>ALERTS</h5>
    <a href="#Add_Alert" role="button" class="btn" data-toggle="modal">Add New</a> 
    <br/>
    <hr/>
    <div id="alerts">  
     <br/>
      ...
      <tbody>
        <?php foreach ($alerts_data as $value) { 
          ...
          <tr>
            ...
            <td><a href="#Edit_Alert" class="edit_alert_row_btn" data-toggle="modal" id="<?php echo $id;?>" value="<?php echo $id;?>">Edit</a></td>
          </tr>
          <?php }?>
        </tbody>
    ...
    <div id="Edit_Alert" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal" aria-hidden="true"></button>
        <h2 id="myModalLabel">Edit Alert</h2>
      ...
      <div class="modal-footer">
        ...
        <button id="edit_alert_btn" class="btn btn-primary edit_alert_btn">Save</button>
      </div>
    </div>

    <hr/>
    <h5>COMMODITIES</h5>
    <a href="#Add_Commodity" role="button" class="btn" data-toggle="modal">Add New</a> 
    <br/>
    <hr/>
    <div id="commodities">  
      <br/>
        ...
        <tbody>
          ...
          foreach ($commodities_data as $row) {
            ...
            <tr>      
              ...
              <td><a href="#Edit_Commodity" role="button" class="edit_commodity_row_btn" id="<?php echo $row['id']?>" value="<?php echo $row['id']?>" data-toggle="modal">Edit</a></td>
            </tr> 
            <?php 
            $i++;
          }?>
    ...
    <div id="Edit_Commodity" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal" aria-hidden="true"></button>
        <h3 id="myModalLabel">Edit Commodity</h3>
      ...
      <div class="modal-footer">
        <button class="btn" data-dismiss="modal" aria-hidden="true">Close</button>
        <button id="edit_commodity_btn" class="btn btn-primary edit_commodity_btn">Save Changes</button>
      </div>
    </div>

    <div id="Add_Deadline" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal" aria-hidden="true"></button>
        <h2 id="myModalLabel">Add Deadline</h2>
      ...
      <div class="modal-footer">
        <button class="btn" data-dismiss="modal" aria-hidden="true">Close</button>
        <button id="add_deadline_btn" class="btn add_deadline_btn btn-primary">Save</button>
      </div>
    </div>


    <div id="Edit_Deadline" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal" aria-hidden="true"></button>
        <h3 id="myModalLabel">Edit Deadline</h3>
      ...
      <div class="modal-footer">
        <button class="btn" data-dismiss="modal" aria-hidden="true">Close</button>
        <button id="edit_deadline_btn" class="btn edit_deadline_btn btn-primary">Save Changes</button>
      </div>
    </div>
    ...
    <!-- Add Commodity-->
    <div id="Add_Commodity" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal" aria-hidden="true"></button>
        <h2 id="myModalLabel">Add Commodity</h2>
      ...
      <div class="modal-footer">
        <button class="btn" data-dismiss="modal" aria-hidden="true">Close</button>
        <button id="add_commodity_btn" class="btn btn-primary">Save</button>
      </div>
    </div>
    ...
    <!-- Add Alert-->
    <div id="Add_Alert" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal" aria-hidden="true"></button>
        <h2 id="myModalLabel">Add Alert</h2>
      ...
      <div class="modal-footer">
        <button class="btn" data-dismiss="modal" aria-hidden="true">Close</button>
        <button id="add_alert_btn" class="btn btn-primary">Save</button>
      </div>
    </div>
  </div>
