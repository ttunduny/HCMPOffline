  ...
  <div id="content">  
    ...
    <div id="deadlines">  
      ...
      <!--div class="modal fade" id="Add_Commodity" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
        <div class="modal-dialog">
          <div class="modal-content">
            <div class="modal-header">
              ...
              <h4 class="modal-title" id="myModalLabel">Add_Commodity</h4>
            </div>
        ...
        <div class="modal-footer">
          ...
          <button id="add_commodity_btn" class="btn add_commodity_btn btn-default">Save</button>
        </div>
      </div>     
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-footer">
          ...
          <button type="button" id="edit_alert_btn" class="btn btn-primary">Save Changes</button>
        </div>
      </div>
    </div>
  </div>
    ...
    <div class="modal fade" id="Add_Deadline" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
      ...
      <!--div class="modal fade" id="Add_Commodity" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
        ...
        <div class="modal-footer">
          <button class="btn" data-dismiss="modal" aria-hidden="true">Close</button>
          <button id="add_commodity_btn" class="btn btn-default">Save</button>
        </div>
      </div>
    </div>
  -->
