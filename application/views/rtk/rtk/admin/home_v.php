...
<div>
<?php { ?>
<div id="fixed-topbar" style="z-index:10;position: fixed; top: 74px;background:rgb(164, 213, 58); width: 100%;padding: 7px 1px 0px 13px;border-bottom: 1px solid #ccc;border-bottom: 1px solid #ccc;border-radius: 4px 0px 0px 4px;">
