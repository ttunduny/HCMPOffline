 <?php echo "<pre>"; print_r($report_data); echo "</pre>"; exit;?>
 <h1 class="page-header" style="margin: 0;font-size: 1.6em;">Potential Expiries <?php echo $county_name.' District Store '.date('Y') ;?></h1>
