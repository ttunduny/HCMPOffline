...
echo form_open('stock/update_facility_stock_from_meds_order', $att);
...
<div class="container" style="width: 96%; margin: auto;">
	...
	&nbsp;&nbsp;<strong>*NB</strong>	&nbsp;Commodities as supplied by MEDS</p></div>
...
<div class="row-fluid" id="updateord">
	<fieldset  class="col-md-3">
		...
		<div >
			...
			<input type="text" class="form-control"  readonly="readonly"  name="orderby" value="<?php echo $ordered_by[0]['fname'].' '.$ordered_by[0]['lname'];?>" />

			<label>Order Sheet No :</label>
			<input type="text" class="form-control"  name="order"   readonly="readonly" value="N/A" />
	...
	<fieldset  class="col-md-3">
		...
		<div >
			...
			<input type="text" class="form-control"   name="appby"  readonly="readonly" value="<?php $approved_by = ($approved_by=='') ? 'N/A' : $approved_by ; echo $approved_by; ?>" />
	...
	<fieldset  class="col-md-3">
		...
		<div >
			...
			<input type="text" class="form-control"  name="warehouse" id="warehouse" />
			 ...
			 <label>MEDS Order No :*</label>
			<input type="text" class="form-control"  name="meds_order_no" value="" id="meds_order_no"  />
		</div>
	</fieldset>
...
<div class="container-fluid"  style="margin-top: 2%">
 ...
 <?php  $new_count=0; foreach($order_details as $order_details):
        ...
        <td><input class='form-control input-small batch_no' type='text' name='batch_no[$new_count]' value='' required='required'/></td>
        <td><input class='form-control input-small manu' type='text' name='manu[$new_count]' value='MEDS' required='required' readonly/></td>
        <td><input class='form-control input-small clone_datepicker' value='' type='text' name='expiry_date[$new_count]' 
