<div class="row" style="margin-top: 1%;margin-left:2%;width:88%;">
  <div class="col-md-12">     
    <ul class="nav nav-tabs" id="myTab">
      ...
      <!-- <li><a href="#redistributions" data-toggle="tab">Current Redistributions</a></li>         -->
...
<script type="text/javascript">
  $(document).ready(function(){
    ...
    function load_reversal_table(){
      var base_url_main = "<?php echo base_url() . 'issues/get_reversal_table/'; ?>";      
      $.get(base_url_main, function(data){
        $("#issues").html(data);        
      });
    }

    function load_redistribution_table(){
      var base_url_main = "<?php echo base_url() . 'admin/get_redistribution_reverse_table/'; ?>";      
      $.get(base_url_main, function(data){
        $("#redistributions").html(data);        
      });
    }
