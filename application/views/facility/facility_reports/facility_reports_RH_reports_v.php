...
<div class="table-responsive" style="height:400px; overflow-y: auto;">
	<table  class="table table-hover table-bordered" id="reproductive_health_reports_table" >
...
$(document).ready(function() {	
 var $table = $('table');
//float the headers
	$('#reproductive_health_reports_table').dataTable({
		"sDom": "T lfrtip",
	...
	$('#reproductive_health_reports_table_filter label input').addClass('form-control');
	$('#reproductive_health_reports_table_length label select').addClass('form-control');
 //  $table.floatThead({ 
	//  scrollingTop: 100,
	//  zIndex: 1001,
