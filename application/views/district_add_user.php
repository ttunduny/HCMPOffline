...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <section id="registersec">
    	...
    	<input type="email" class="validate[required,custom[email]]" placeholder="Johndoe@domain.com" name="email" readonly="readonly"/>
	...
	<select id="facility" name="facility" class="registerdropDown">
    <option>Select Facility Name</option>
		<?php 
		foreach ($facility as $facilities) {
			$id=$facilities->id;
			$facilityname=$facilities->facility_name;
			?>
			<option value="<?php echo $id;?>"><?php echo $facilityname;?></option>
		<?php }
		?>
	</select>
