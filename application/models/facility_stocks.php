...
class Facility_stocks extends Doctrine_Record {
	...
	public static function get_distinct_stocks_for_this_district_store($district_id) {
		$store_stocks = Doctrine_Manager::getInstance() -> getCurrentConnection() -> fetchAll("SELECT DISTINCT dst.commodity_id as commodity_id,fs.id as facility_stock_id,ds.expiry_date, c.commodity_name,c.commodity_code,c.unit_size,
...
from
   ...
   hcmp_rtk.drug_commodity_map ON drug_commodity_map.old_id = historical_stock.drug_id
	...
	public static function getpotentialexpcount($county_id, $district_id) {
		$and_data = (isset($district_id) &&($district_id>0))? "AND facilities.district=$district_id ": "AND districts.county=$county_id" ;
