...
<table class='body-wrap'>
	<tr>
		...
		<td></td>
			...
			//$path = $_SERVER["DOCUMENT_ROOT"].'/HCMP-1';
			$file_name='HCMP_Facility_Activity_Log_Summary';
			$attach_file="../../print_docs/excel/excel_files/".$file_name.'.xls';
			
			$response= $this->hcmp_functions->send_log_summary_email($message,$subject,$attach_file);
